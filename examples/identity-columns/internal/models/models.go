...
// Product demonstrates GENERATED ALWAYS AS IDENTITY (strict, recommended)
// The ID column will ALWAYS be auto-generated. Manual INSERT requires OVERRIDING SYSTEM VALUE.
type Product struct {
...
// Order demonstrates GENERATED BY DEFAULT AS IDENTITY (flexible)
// The ID column is auto-generated by default, but can be manually overridden if needed.
type Order struct {
...
// Customer demonstrates legacy SERIAL for comparison
// SERIAL is still supported for backward compatibility
