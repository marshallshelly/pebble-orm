...
- New Pebble ORM logo — a smooth stacked-stone cairn that reads as both a pebble and database layers, with a glowing Go-cyan crown pebble. The `assets/images/logo.png` hero is a Nano Banana 2 (Gemini) render; `assets/images/logo.svg` is a flat vector mark for favicon/small sizes.
